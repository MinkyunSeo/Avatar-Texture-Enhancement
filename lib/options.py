...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_data.add_argument('--rot_step', type=int, default=8)
        ...
        g_exp.add_argument('--patch_sample', action='store_true')
        g_exp.add_argument('--use_3D_SSIM', action='store_true')
        g_exp.add_argument('--patch_len', type=int, default=0.001)
        g_exp.add_argument('--patch_size', type=int, default=3)
        ...
        g_sample.add_argument('--sigma', type=float, default=0.01, help='perturbation standard deviation for positions')
        ...
        parser.add_argument('--results_path', type=str, default='./outputs', help='path to save results ply')
